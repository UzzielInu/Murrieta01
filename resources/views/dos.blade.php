      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active text-center">
            <img src="{{ asset('img/portada/logo.jpg') }}" alt="" height="100%" class="">
            <div class="carousel-caption d-none d-md-block">
              <!-- <h3 class="text-secondary">Murrieta</h3>
              <p class="text-secondary">100% Mexicano</p> -->
            </div>
          </div>
          <!-- Slide Two - Set the background image for this slide in the line below -->
          <div class="carousel-item text-center">
            <img src="{{ asset('img/portada/3.jpg') }}" alt="" height="100%" class="">
            <img src="{{ asset('img/portada/4.jpg') }}" alt="" height="100%" class="">
            <div class="carousel-caption d-none d-md-block">
             <!--  <h3>Second Slide</h3>
          ...
          <div class="carousel-item text-center">
            <img src="{{ asset('img/portada/5.jpg') }}" alt="" height="100%" class="">
            <img src="{{ asset('img/portada/6.jpg') }}" alt="" height="100%" class="">
            <div class="carousel-caption d-none d-md-block">
              <h5 class="text-ligth">Camisas de temporada</h5>
              <!-- <p>This is a description for the third slide.</p> -->
            </div>
          </div>
          <div class="carousel-item text-center">
            <img src="{{ asset('img/portada/1.jpg') }}" alt="" height="100%" class="">
            <img src="{{ asset('img/portada/2.jpg') }}" alt="" height="100%" class="">
            <div class="carousel-caption d-none d-md-block">
              <!-- <h3>Third Slide</h3> -->
              <!-- <p>This is a description for the third slide.</p> -->
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-footer text-center">
              <a href="#" class="btn btn-primary col-sm-6">Ver</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
