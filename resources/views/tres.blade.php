...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Murrieta</a>
    ...
    <div class="container">
      ...
      <div class="row col text-center text-lg-left">
        <div class="row col-md-12 justify-content-center">
          <h3>Manga Corta</h3>
        </div>
        <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="{{ asset('img/tienda/Camisa Blanca/Manga_Corta/MC1b.jpg') }}" alt="">
          </a>
        </div>
        <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100">
